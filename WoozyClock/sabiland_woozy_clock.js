    ...
    jQuery.fn.extend({
        ...
        woozyclock: function (options) {
            ...
            return this.each(function () {
                ...
                var jCnvDrawing = jQuery(this);
                var cnvDrawing = jQuery(this)[0];
                ...
                */
                ...
                function tickAnimEngine() {
                    ...
                    if (animGS.runners.length > howManyTimeSeparators) {
                        ...
                        jQuery('#m_spnPageInConstructionForAnim').css('color', '#' + RGB2Hex(firstRunner.backR, firstRunner.backG, firstRunner.backB));
                    }
                ...
                */
                ...
                // 24052019 - OBSOLETE NOT WORKING ANYMORE
